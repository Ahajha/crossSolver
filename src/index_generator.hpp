...
class index_generator
{
  ...
  public:
	...
	class iterator
	{
		...
		[[nodiscard]] constexpr iterator(T inc, T init) noexcept : inc_amount(inc), value(init) {}
	...
	[[nodiscard]] constexpr iterator begin() const noexcept { return iterator(inc_amount, offset); }
